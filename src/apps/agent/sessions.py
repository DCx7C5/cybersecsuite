"""agent.sessions — Session lifecycle management wrapping claude_agent_sdk.
...
logger = getLogger("agent.sessions")
...
class SessionManager:
    ...
    def register(
        ...
        logger.info("registered session %s agent=%s mode=%s", session_id, agent_name, mode)
        return record
