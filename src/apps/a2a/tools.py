...
from core.cssmcp.sdk_compat import ToolMetadata
...
def register_tool(
    ...
    """Decorator — registers an async callable as an A2A tool.

    Usage::

        @register_tool("ping", "Check agent liveness", {"type": "object", "properties": {}})
