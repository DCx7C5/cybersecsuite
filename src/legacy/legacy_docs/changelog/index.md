...
git log --oneline -20 -- legacy_docs/changelog/

# View what changed in Phase 5B
git log -p -- legacy_docs/changelog/phase5b_scope_enforcement_changelog.md

# View all Phase 5 changes
git log --oneline -20 | grep -i phase5

# See commit diff
git show a9591739:legacy_docs/changelog/phase5b_scope_enforcement_changelog.md
```
