"""AI asgi routing tools — SDK in-process MCP server module.
...
@tool(
    "proxy_chat",
    "Route a chat completion through the AI asgi with multi-provider fallback.",
    {
        "prompt": "string",
...
@tool("proxy_usage", "Return AI asgi usage summary: tokens, costs, requests by provider.", {})
