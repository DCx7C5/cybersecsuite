...
Bridges the in-process SdkMcpServer (sdk_compat) to the mcp package's
stdio transport so Claude can connect via mcp.json.

Usage (mcp.json):
    uv run python -m cybersec_mcp
"""
...
logger = logging.getLogger("cybersec_mcp.server")
