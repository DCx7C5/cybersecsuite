...
Usage::
    ...
    # Open (or resume) a named session — writes go to .claude/sessions/<name>/
...
Scope priority (lowest → highest — never change this order):
  ...
  4. Session $(pwd)/.claude/sessions/<name>/  ← always wins for writes
"""
...
class CyberSecSuiteSDK:
    ...
    def __init__(
        ...
        self._sessions_dir: Path = self.project_dir / ".claude" / "sessions"
