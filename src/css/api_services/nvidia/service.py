...
class NVIDIAApiService(BaseApiServiceClient, BaseStreamingHandler):
    """Nvidia API service with streaming support."""
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.NVIDIA,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call Nvidia with OpenAI-compatible streaming."""
