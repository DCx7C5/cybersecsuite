...
class CohereApiService(BaseApiServiceClient, BaseStreamingHandler):
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.COHERE,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call Cohere with OpenAI-compatible streaming."""
