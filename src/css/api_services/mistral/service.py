...
class MistralApiService(BaseApiServiceClient, BaseStreamingHandler):
    """Mistral API service with streaming support."""
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.MISTRAL,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call Mistral with OpenAI-compatible streaming."""
