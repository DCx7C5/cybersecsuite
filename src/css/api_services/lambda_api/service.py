...
class LambdaApiService(BaseApiServiceClient, StreamingHandler):
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.LAMBDA,
    ...
    async def get_models(self) -> list[ModelMetadata]:
        """Fetch available Lambda models from API."""
        # TODO: Call Lambda models endpoint
        return []
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call Lambda with OpenAI-compatible streaming."""
