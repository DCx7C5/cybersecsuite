...
class NscaleApiService(BaseApiServiceClient, BaseStreamingHandler):
    """nScale API service with streaming support."""
    ...
    def __init__(
        ...
        super().__init__(
            ...
            api_key=api_key or os.getenv("NSCALE_API_KEY"),
            base_url=base_url,
