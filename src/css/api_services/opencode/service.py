...
class OpenCodeApiService(BaseApiServiceClient, BaseStreamingHandler):
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.OPENCODE,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call OpenCode with OpenAI-compatible streaming."""
