...
class TogetherApiService(BaseApiServiceClient, BaseStreamingHandler):
    """Together API service with streaming support."""
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.TOGETHER,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call Together with OpenAI-compatible streaming."""
