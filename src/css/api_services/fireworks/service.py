"""Fireworks API service provider."""
...
class FIREWORKSApiService(BaseApiServiceClient, BaseStreamingHandler):
    """Fireworks API service with streaming support."""
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.FIREWORKS,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call Fireworks with OpenAI-compatible streaming."""
