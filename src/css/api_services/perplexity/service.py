"""Perplexity API service provider."""
...
class PerplexityApiService(APIProviderBase, StreamingHandler):
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.PERPLEXITY,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call Perplexity with OpenAI-compatible streaming."""
