"""AI21 Labs API service provider."""
...
class AI21ApiService(BaseApiServiceClient, BaseStreamingHandler):
    """AI21 Labs API service with streaming support."""
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call AI21 Labs with OpenAI-compatible streaming."""
