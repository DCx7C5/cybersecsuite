"""SambaNova API service provider."""
...
class SambaNovaApiService(BaseApiServiceClient, BaseStreamingHandler):
    """SambaNova API service with streaming support."""
    ...
    def __init__(
        ...
        super().__init__(
            provider_id=ProviderType.SAMBANOVA,
    ...
    async def call_llm(
        ...
        **kwargs,
        ...
        """Call SambaNova with OpenAI-compatible streaming."""
