"""Account types — represents external provider credentials and authentication state."""
...
from css.core.types.base import BaseEntity
from css.core.types.headers import BaseAccountHeader
