"""agents.streaming — SSE adapter for streaming agents query results.

Converts the claude_agent_sdk async generator (query() with partial messages)
into SSE-ready dicts consumed by dashboard /api/agents-query endpoint.
"""
...
logger = logging.getLogger("agents.streaming")
...
async def stream_query(
    ...
    Yield types:
        ...
        {"type": "tool_use", "name": str, "input": dict}  — tools invocation
        {"type": "tool_result", "name": str, "content": str} — tools output
