...
class A2AAgentError(BaseA2AExceptions):
    ...
    def __init__(self, message: str | None = None, agent_name: str | None = None, **kwargs):
...
class A2ACommunicationError(BaseA2AExceptions):
    ...
    def __init__(self, message: str | None = None, endpoint: str | None = None, **kwargs):
        ctx = kwargs.get("context", {})
        if endpoint:
...
class A2ATimeoutError(BaseA2AExceptions):
    ...
    def __init__(self, message: str | None = None, timeout_seconds: int | None = None, **kwargs):
        ctx = kwargs.get("context", {})
        if timeout_seconds:
...
class PauseRequestError(BaseA2AExceptions):
    ...
    def __init__(self, message: str | None = None, request_id: str | None = None, **kwargs):
        ctx = kwargs.get("context", {})
        if request_id:
