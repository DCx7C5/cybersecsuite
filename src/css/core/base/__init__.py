"""Core base package — flat re-export surface (renamed from types/ to base/)."""
...
from .sdk import BaseLocalSDK

# ── Base emitter ──────────────────────────────────────────────────────────────
from .emitter import BaseEmitterClass
...
# ── Base workflow types ───────────────────────────────────────────────────────
from .workflow import BaseTask, BaseTaskScope

# ── Error mappers ─────────────────────────────────────────────────────────────
from .error_mapper import BaseErrorMapper
...
from .qol_registry import QoLPresetRegistry
