...
class AgentLike(Protocol):
    ...
    @property
    def header(self) -> Any:  # BaseAgentHeader
        """Entity header with identity."""
        ...
    
    @property
    def communicator(self) -> Any:  # BaseCommunicator | None
    ...
    @property
    def tools(self) -> List[Any]:  # List[BaseTool]
...
class SkillLike(Protocol):
    ...
    @property
    def header(self) -> Any:  # BaseSkillHeader
        """Entity header with identity."""
        ...
...
class ToolLike(Protocol):
    ...
    @property
    def header(self) -> Any:  # BaseToolHeader
        """Entity header with identity."""
        ...
...
class TeamMemberLike(Protocol):
    ...
    @property
    def header(self) -> Any:  # BaseHeader
        """Entity header with identity."""
        ...
