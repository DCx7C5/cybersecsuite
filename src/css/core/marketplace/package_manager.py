...
async def fetch_index(index_url: str) -> dict:
    ...
    try:
        ...
        raise MarketplaceError("Timeout fetching marketplace index")
...
async def check_for_updates(
    ...
    try:
        ...
        logger.warning("Could not check for updates: index not found")
        return {}
...
async def install_package(
    ...
    try:
        ...
        try:
            ...
            raise MarketplaceError("Timeout downloading package")
        except PackageNotFoundError:
            raise
