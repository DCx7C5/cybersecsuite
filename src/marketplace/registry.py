...
class MarketplaceRegistry:
    ...
    def seed(self, items: list[MarketplaceItem]) -> None:
    ...
    def list_installed(self) -> list[MarketplaceItem]:
...
def get_registry() -> MarketplaceRegistry:
    ...
    Returns:
        The initialised ``MarketplaceRegistry`` instance.
    """
    global _registry
...
_reg = get_registry()
_reg.seed(_SEED_ITEMS)
_reg.load_catalog()
_reg._load_installed()
