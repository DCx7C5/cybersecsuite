...
class Agent(BaseAgent):
    """Concrete agent entity with HTTP endpoint and metadata.

    Extends BaseAgent with:
      - HTTP endpoint (base_url) for remote agent discovery
    ...
    def is_default(self) -> bool:
        """Check if this agent is marked as default."""
    ...
    def client(self):
        """Lazily create an HTTP client for remote agent communication.
