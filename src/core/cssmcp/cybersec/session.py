...
from core.cssmcp.cybersec.helpers import JsonDict, _get_current_scope, sdk_result, sdk_error
...
async def agent_registry(args: dict[str, Any]) -> JsonDict:
    try:
        ...
        try:
            from core.registries.marketplace import get_registry as _get_mkt_registry
