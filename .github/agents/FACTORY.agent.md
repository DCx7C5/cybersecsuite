...
name: agent-factory
description: >-
  Universal agent factory. Provide any .claude/agents/*.md file as context and
  say 'create perfect agent'. Generates a complete, production-grade agent with
  rich persona, 9-chapter blueprint, self-reflection mechanisms, and
