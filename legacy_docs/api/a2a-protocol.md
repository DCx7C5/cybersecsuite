...
For per-agent model routing, see [docs/agent-sdk-integration.md](../agents/sdk-integration.md).
...
No Python wrapper classes needed per agent. See [docs/agent-sdk-integration.md](../agents/sdk-integration.md) for full details.
