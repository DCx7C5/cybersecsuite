...
|--------|----------|---------|
| GET | `/api/a2a` | Read/Retrieve data |
| GET | `/api/a2a/tasks` | Read/Retrieve data |
| POST | `/api/a2a/tasks` | Create new item |
| PATCH | `/api/a2a/tasks/{id}` | Update item |
| DELETE | `/api/a2a/tasks/{id}` | Remove item |
