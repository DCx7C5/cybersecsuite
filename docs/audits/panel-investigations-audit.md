# Panel Audit: Investigations

**Generated:** /home/daen/Projects/cybersecsuite

## Overview
- **Panel Name:** Investigations
...
|--------|----------|---------|
| GET | `/api/investigations` | Read/Retrieve data |
| POST | `/api/investigations` | Create new item |
| PATCH | `/api/investigations/{id:int}` | Update item |
| DELETE | `/api/investigations/{id:int}` | Remove item |
