# Panel Audit: Intel Feed

**Generated:** /home/daen/Projects/cybersecsuite

## Overview
- **Panel Name:** Intel Feed
...
|--------|----------|---------|
| GET | `/api/intel-sources` | Read/Retrieve data |
| POST | `/api/intel-sources` | Create new item |
| POST | `/api/intel-sources/seed` | Create new item |
| PATCH | `/api/intel-sources/{id:int}` | Update item |
| DELETE | `/api/intel-sources/{id:int}` | Remove item |
