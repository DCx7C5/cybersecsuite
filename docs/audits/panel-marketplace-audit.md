# Panel Audit: Marketplace

**Generated:** /home/daen/Projects/cybersecsuite

## Overview
- **Panel Name:** Marketplace
- **Type:** Standard Dashboard Panel
- **Status:** ✓ ACTIVE

## API Endpoints

### Available Endpoints (3 total)

| Method | Endpoint | Purpose |
|--------|----------|---------|
| GET | `/api/marketplace` | Read/Retrieve data |
| GET | `/api/marketplace/{item_id}` | Read/Retrieve data |
| GET | `/api/marketplace/installed` | Read/Retrieve data |
