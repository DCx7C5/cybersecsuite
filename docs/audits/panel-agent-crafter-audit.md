# Panel Audit: Agent Crafter

**Generated:** /home/daen/Projects/cybersecsuite

## Overview
- **Panel Name:** Agent Crafter
...
|--------|----------|---------|
| POST | `/api/agents/crud` | Create new item |
| GET | `/api/agents/crud/{name}` | Read/Retrieve data |
| PUT | `/api/agents/crud/{name}` | Replace item |
| DELETE | `/api/agents/crud/{name}` | Remove item |
| POST | `/api/agents/generate` | Create new item |
