# Panel Audit: Providers Hub

**Generated:** /home/daen/Projects/cybersecsuite

## Overview
- **Panel Name:** Providers Hub
...
|--------|----------|---------|
| GET | `/api/providers` | Read/Retrieve data |
| GET | `/api/providers/hub` | Read/Retrieve data |
| PATCH | `/api/providers/{provider_id}` | Update item |
