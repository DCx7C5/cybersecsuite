# Panel Audit: QoL Controls

**Generated:** /home/daen/Projects/cybersecsuite

## Overview
- **Panel Name:** QoL Controls
...
|--------|----------|---------|
| GET | `/api/qol` | Read/Retrieve data |
| POST | `/api/qol` | Create new item |
| DELETE | `/api/qol` | Remove item |
| GET | `/api/qol/presets` | Read/Retrieve data |
| POST | `/api/qol/presets/{name}` | Create new item |
