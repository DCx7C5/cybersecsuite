...
|--------|----------|---------|
| GET | `/api/templates` | Read/Retrieve data |
| POST | `/api/templates` | Create new item |
| DELETE | `/api/templates` | Remove item |
| PATCH | `/api/templates/{id}` | Update item |
