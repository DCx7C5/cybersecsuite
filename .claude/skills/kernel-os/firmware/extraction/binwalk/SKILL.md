...
nist_csf: 
tags: 
source: "/home/daen/Projects/Anthropic-Cybersecurity-Skills/skills/performing-firmware-extraction-with-binwalk/SKILL.md"
---
...
# Log IOCs discovered
mcp__cybersec__add_ioc(type="...", value="...", confidence=0.9, source="performing-firmware-extraction-with-binwalk")
...
## Agent
Invoke via: `@firmware-analysis-analyst` or `@cybersec-agent`
