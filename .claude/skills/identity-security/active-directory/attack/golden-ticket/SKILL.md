...
nist_csf: 
tags: 
source: "/home/daen/Projects/Anthropic-Cybersecurity-Skills/skills/detecting-golden-ticket-attacks-in-kerberos-logs/SKILL.md"
---
...
# Log IOCs discovered
mcp__cybersec__add_ioc(type="...", value="...", confidence=0.9, source="detecting-golden-ticket-attacks-in-kerberos-logs")
...
## Agent
Invoke via: `@threat-hunting-analyst` or `@cybersec-agent`
