...
Parses Certipy output to identify ESC1-vulnerable certificate plugins
...
def generate_esc1_report(certipy_data: dict) -> str:
    ...
    if not templates:
        templates = certipy_data.get("plugins", {})
    ...
    report_lines.append("  1. Disable ENROLLEE_SUPPLIES_SUBJECT on all vulnerable plugins")
